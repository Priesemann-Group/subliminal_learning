...
OUTDIR="./output/student_minus_one_layer_m50"
mkdir -p "$OUTDIR"
...
for seed in $SEEDS; do
    ...
    python ../../src/run_subliminal.py \
        ...
        --data-dir ../../MNIST \
        --seed "$seed" \
        --sweep-name "mlp_student_minus_one_layer" \
        --run-label "teacher_2hid_student_1hid_shared_heads" \
        --dataset mnist \
        --teacher-type mlp \
        --student-type mlp \
        ...
        --student-init fc1:random,class_head:A,aux_head:A \
